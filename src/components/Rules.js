  ...
  return(
      <div className="RulesPage">
        ...
        <ol>
          ...
          <li>Click through the pages to reach the designated. Use the blue links to properly click through. Other colored links will not allow for proper game play.</li>
          <li>At the end there is the option to make another attempt of the same <i>Mission</i> or initiate a new one</li>
        </ol>
        <p>
          Links in the side panel open articles in an external window.
        </p>
